                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                            image: NetworkImage(
                                'https://raw.githubusercontent.com/MokshadaKesarkar/workshop-website/master/assets/Akanksha-web.jpg'),
                            fit: BoxFit.cover)),
                  ),
                  SizedBox(
                    height: 30.0,
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                            image: NetworkImage(
                                'https://raw.githubusercontent.com/MokshadaKesarkar/workshop-website/master/assets/pravin-web.jpg'),
                            fit: BoxFit.cover)),
                  ),
                  SizedBox(
                    height: 30.0,
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                            image: NetworkImage(
                                'https://raw.githubusercontent.com/MokshadaKesarkar/workshop-website/master/assets/akash-web.png'),
                            fit: BoxFit.cover)),
                  ),
                  SizedBox(
                    height: 30.0,
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                        ...
                        image: DecorationImage(
                            image: NetworkImage(
                                'https://raw.githubusercontent.com/MokshadaKesarkar/workshop-website/master/assets/reethik-web.jpg'),
                            fit: BoxFit.cover)),
                  ),
                  SizedBox(
                    height: 30.0,
...
class PhoneAbout extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SingleChildScrollView(
      child: Column(
        children: [
          Navbar(),
          buildPhoneNikhilCard('Nikhil Naidu', 'Developer', skills, context),
          buildPhoneAakankshaCard('Aakanksha Bomble', 'Developer', skills, context),
          buildPhonePravinCard('Pravin Choudhary', 'Developer', skills, context),
          buildPhoneAkashCard('Akash Tripathi', 'Developer', skills, context),
          buildPhoneTejuCard('Tejashree Jadhav', 'Developer', skills, context),
          buildPhoneReethikCard('Reethik Thota', 'Developer', skills, context),
          buildPhoneMokshCard('Mokshada Kesarkar', 'Developer', skills, context),
          buildPhoneRiddhiCard('Riddhi Kadam', 'Developer', skills, context),
  ...
  Widget buildPhoneNikhilCard(String name, String desc,  List<String> skills, BuildContext context) {
    double width = MediaQuery.of(context).size.width;
    double height = MediaQuery.of(context).size.height;
  ...
  Widget buildPhoneAakankshaCard(String name, String desc,  List<String> skills, BuildContext context) {
    double width = MediaQuery.of(context).size.width;
    double height = MediaQuery.of(context).size.height;
  ...
  Widget buildPhoneAkashCard(String name, String desc,  List<String> skills, BuildContext context) {
    double width = MediaQuery.of(context).size.width;
    double height = MediaQuery.of(context).size.height;
  ...
  Widget buildPhonePravinCard(String name, String desc,  List<String> skills, BuildContext context) {
    double width = MediaQuery.of(context).size.width;
    double height = MediaQuery.of(context).size.height;
              ...
              child: Column(
                children: [
                  ...
                  Padding(
                    padding: const EdgeInsets.symmetric(vertical: 10.0),
                    child: Text(
                      '"Whenever I learn something new. I try to teach someone the same thing. What I found is my knowledge gets 10x each time I do that"',
                      style: TextStyle(color: Colors.white, fontSize: 15.0),
                    ),
                  ),
                ],
  ...
  Widget buildPhoneTejuCard(String name, String desc,  List<String> skills, BuildContext context) {
    double width = MediaQuery.of(context).size.width;
    double height = MediaQuery.of(context).size.height;
  ...
  Widget buildPhoneReethikCard(String name, String desc,  List<String> skills, BuildContext context) {
    double width = MediaQuery.of(context).size.width;
    double height = MediaQuery.of(context).size.height;
  ...
  Widget buildPhoneMokshCard(String name, String desc,  List<String> skills, BuildContext context) {
    double width = MediaQuery.of(context).size.width;
    double height = MediaQuery.of(context).size.height;
  ...
  Widget buildPhoneRiddhiCard(String name, String desc,  List<String> skills, BuildContext context) {
    double width = MediaQuery.of(context).size.width;
    double height = MediaQuery.of(context).size.height;
